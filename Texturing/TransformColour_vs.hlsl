...
PixelShaderInput main(BasicVertex modelVertex)
{
    ...
    // Pass the vertex colour from the mesh on to the pixel shader where it will be used
    output.vertexColour = modelVertex.colour;

    // Pass texture coordinates (UVs) on to the pixel shader, the vertex shader doesn't need them
    /*** MISSING - a simple line, used in previous lab effect files ***/
