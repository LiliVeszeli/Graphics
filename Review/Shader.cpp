...
bool LoadShaders()
{
    ...
    gSimpleVertexShader = LoadVertexShader("TransformLighting_vs"); // Note how the shader files are named to show what type they are
    gSimplePixelShader  = LoadPixelShader ("TextureColour_ps"    );
