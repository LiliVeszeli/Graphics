...
// If we have multiple models want to update the world matrix from C++ to GPU multiple times per frame. We did
// this in a previous week when we drew two cubes.
