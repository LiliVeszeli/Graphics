...
bool LoadShaders()
{
    ...
    gSimpleVertexShader = LoadVertexShader("TransformLight_vs"); // Note how the shaders are named to show what type they are
    gSimplePixelShader  = LoadPixelShader ("Simple_ps"); 
