...
D3D11_INPUT_ELEMENT_DESC gBasicVertexDesc[] =
{
    ...
    { "UV",        0,           DXGI_FORMAT_R32G32_FLOAT,     0,    12,       D3D11_INPUT_PER_VERTEX_DATA,  0 }, // UV has 3 floats starting at offset 12 (= size of the earlier 3 floats)
};
...
{
	CVector3{ -1.0f, 1.0f,-1.0f }, CVector2{ 0.0f, 0.0f }, // Front face
	...
	CVector3{  1.0f, 1.0f,-1.0f }, CVector2{ 0.0f, 0.0f }, // Right face
	CVector3{  1.0f, 1.0f, 1.0f }, CVector2{ 1.0f, 0.0f },
	CVector3{  1.0f,-1.0f,-1.0f }, CVector2{ 0.0f, 1.0f },
	CVector3{  1.0f,-1.0f, 1.0f }, CVector2{ 1.0f, 1.0f },
									 
	CVector3{  1.0f, 1.0f, 1.0f }, CVector2{ 0.0f, 0.0f }, // Etc.
	CVector3{ -1.0f, 1.0f, 1.0f }, CVector2{ 1.0f, 0.0f },
	CVector3{  1.0f,-1.0f, 1.0f }, CVector2{ 0.0f, 1.0f },
	CVector3{ -1.0f,-1.0f, 1.0f }, CVector2{ 1.0f, 1.0f },
...
{
	CVector3{ -100.0f, 0.0f, 100.0f }, CVector2{  0.0f,  0.0f },
	CVector3{  100.0f, 0.0f, 100.0f }, CVector2{ 20.0f,  0.0f },
	CVector3{ -100.0f, 0.0f,-100.0f }, CVector2{  0.0f, 20.0f },
	CVector3{  100.0f, 0.0f,-100.0f }, CVector2{ 20.0f, 20.0f },
};
...
void UpdateScene(float frameTime)
{
    ...
    if (totalFrameTime > fpsUpdateTime)
    {
        ...
        std::string windowTitle = "CO2409 Week 13: Blending - Frame Time: " + frameTimeMs.str() +
