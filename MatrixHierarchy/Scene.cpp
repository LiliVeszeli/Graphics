...
void ReleaseResources()
{
    ...
    delete gRobotMesh;  gRobotMesh = nullptr;
}
...
void UpdateScene(float frameTime)
{
	...
	gAnimated->Control(0, frameTime, Key_I, Key_K, Key_J, Key_L, Key_U, Key_O, Key_Period, Key_Comma, Key_N, Key_M, Key_V, Key_B);

    gRobot->ControlRobot(0, frameTime, Key_I, Key_K, Key_J, Key_L, Key_U, Key_O, Key_Period, Key_Comma, Key_V, Key_B);
